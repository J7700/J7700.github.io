(function ($) {
  ...
  function showControl(shouldShow) {
    ...
    if (shouldShow) {
      ...
      $(".psVideo-shade")
        ...
        .addClass("psVideo-shade-on"); // 遮罩
      $(".player-list")
        .removeClass("player-list-off")
        .addClass("player-list-on"); // 列表
    } else {
      $(".psVideo-shade")
        .removeClass("psVideo-shade-on")
        .addClass("psVideo-shade-off"); // 遮罩
      $(".player-list")
        .removeClass("player-list-on")
        .addClass("player-list-off"); // 列表
    }
  }
  function fillShow() {
    // 全屏
  ...
  function danOn() {
    ...
    if (danText && !isK.test(danText)) {
      ...
      if (full) {
        var danDom =
          "<span class='psVideo-dan-all psVideo-dan-value-full' id='" +
          danIdNow +
          "'</span>";
      } else {
        var danDom =
          "<span class='psVideo-dan-all psVideo-dan-value' id='" +
          danIdNow +
          "'</span>";
      }
