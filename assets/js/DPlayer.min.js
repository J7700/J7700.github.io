  ...
  (() => {
    var n = {
          ...
          function a(n, a) {
            for (var r = {}, i = [], l = 0; l < n.length; l++) {
              ...
              if (-1 !== c) e[c].references++, e[c].updater(u);
                ...
                var y = o(u, a);
                (a.byIndex = l),
                  e.splice(l, 0, { identifier: A, updater: y, references: 1 });
              }
              i.push(A);
            }
            return i;
          ...
          n.exports = function (n) {
            return new Promise(function (e, t) {
              var y,
                ...
                f = n.responseType;
              function b() {
                n.cancelToken && n.cancelToken.unsubscribe(y),
                  n.signal && n.signal.removeEventListener("abort", y);
              }
              a.isFormData(h) &&
              ...
              if (
                (g.open(
                  ...
                  i(x, n.params, n.paramsSerializer),
                  !0
                ),
                (g.timeout = n.timeout),
                "onloadend" in g
                ...
                (g.onabort = function () {
                  g &&
                    (t(new A("Request aborted", A.ECONNABORTED, n, g)),
                    (g = null));
                }),
                (g.onerror = function () {
                ...
                (g.ontimeout = function () {
                  ...
                  n.timeoutErrorMessage && (e = n.timeoutErrorMessage),
                    t(
                      new A(
                        e,
                        a.clarifyTimeoutError ? A.ETIMEDOUT : A.ECONNABORTED,
                        n,
                        g
                      )
                    ),
                ...
                var k =
                  (n.withCredentials || p(x)) && n.xsrfCookieName
                    ? r.read(n.xsrfCookieName)
                    : void 0;
                k && (m[n.xsrfHeaderName] = k);
              }
              "setRequestHeader" in g &&
                a.forEach(m, function (n, e) {
                  void 0 === h && "content-type" === e.toLowerCase()
                    ? delete m[e]
                    : g.setRequestHeader(e, n);
                }),
                a.isUndefined(n.withCredentials) ||
                  (g.withCredentials = !!n.withCredentials),
                f && "json" !== f && (g.responseType = n.responseType),
                "function" == typeof n.onDownloadProgress &&
                  g.addEventListener("progress", n.onDownloadProgress),
                "function" == typeof n.onUploadProgress &&
                  g.upload &&
                  g.upload.addEventListener("progress", n.onUploadProgress),
                (n.cancelToken || n.signal) &&
                  ((y = function (n) {
                    g &&
                      (t(!n || (n && n.type) ? new c() : n),
                      g.abort(),
                      (g = null));
                  }),
                  n.cancelToken && n.cancelToken.subscribe(y),
                  n.signal &&
                    (n.signal.aborted
                      ? y()
        ...
        4568: (n, e, t) => {
          ...
          (l.Axios = r),
            (l.CanceledError = t(8832)),
            (l.CancelToken = t(5027)),
            (l.isCancel = t(1893)),
            (l.VERSION = t(4316).version),
            (l.toFormData = t(6615)),
            (l.AxiosError = t(1766)),
        ...
        8832: (n, e, t) => {
          ...
          var a = t(1766);
          function o(n) {
            a.call(this, null == n ? "canceled" : n, a.ERR_CANCELED),
          ...
          (A.prototype.request = function (n, e) {
            ...
            this.interceptors.request.forEach(function (n) {
              ("function" == typeof n.runWhen && !1 === n.runWhen(e)) ||
                ((o = o && n.synchronous), a.unshift(n.fulfilled, n.rejected));
            });
            var r,
              s = [];
            if (
              ...
              var A = [i, void 0];
              for (
                Array.prototype.unshift.apply(A, a),
                  A = A.concat(s),
                  r = Promise.resolve(e);
                A.length;
        ...
        1766: (n, e, t) => {
          ...
          [
            ...
            (o.from = function (n, e, t, i, l, s) {
              ...
              return (
                a.toFlatObject(n, p, function (n) {
                  return n !== Error.prototype;
                }),
                o.call(p, n.message, e, t, i, l),
                (p.name = n.name),
                s && Object.assign(p, s),
                p
              );
        ...
        9834: (n, e, t) => {
          ...
          n.exports = function (n, e) {
            ...
            var t = {};
            function o(n, e) {
              return a.isPlainObject(n) && a.isPlainObject(e)
                ? a.merge(n, e)
                : a.isPlainObject(e)
                ? a.merge({}, e)
                : a.isArray(e)
            ...
            return (
              a.forEach(Object.keys(n).concat(Object.keys(e)), function (n) {
                var e = p[n] || r,
                  o = e(n);
              ...
              transformRequest: [
                function (n, e) {
                  ...
                  if (a.isURLSearchParams(n))
                    return (
                      p(e, "application/x-www-form-urlencoded;charset=utf-8"),
                      n.toString()
                    );
                  var t,
                    r = a.isObject(n),
                  ...
                  if (
                    (t = a.isFileList(n)) ||
                    (r && "multipart/form-data" === i)
                  ) {
                    var s = this.env && this.env.FormData;
                    return l(t ? { "files[]": n } : n, s && new s());
                  }
                  return r || "application/json" === i
          ...
          n.exports = function (n) {
            ...
            return n
              ? (a.forEach(n.split("\n"), function (n) {
                  if (
                    ((r = n.indexOf(":")),
                    (e = a.trim(n.substr(0, r)).toLowerCase()),
                    (t = a.trim(n.substr(r + 1))),
                    e)
                  ) {
          ...
          n.exports = function (n, e) {
            ...
            function r(n) {
              return null === n
                ...
                : o.isDate(n)
                ? n.toISOString()
                : o.isArrayBuffer(n) || o.isTypedArray(n)
            ...
            return (
              (function n(i, l) {
                if (o.isPlainObject(i) || o.isArray(i)) {
                  ...
                  t.push(i),
                    o.forEach(i, function (t, i) {
                      if (!o.isUndefined(t)) {
                        var s,
                          p = l ? l + "." + i : i;
                        if (t && !l && "object" === a(t))
                          if (o.endsWith(i, "{}")) t = JSON.stringify(t);
                          else if (o.endsWith(i, "[]") && (s = o.toArray(t)))
                            return void s.forEach(function (n) {
              ...
              assertOptions: function (n, e, t) {
                ...
                for (var o = Object.keys(n), i = o.length; i-- > 0; ) {
                  ...
                  if (s) {
                    ...
                    throw new r("Unknown option " + l, r.ERR_BAD_OPTION);
                }
              },
              validators: i,
            });
      ...
      (() => {
        ...
        function C(n, e) {
          try {
            ...
            if (e && ("object" === f(e) || "function" == typeof e)) {
              var t = e.then;
              if (e instanceof E)
                return (n._state = 3), (n._value = e), void w(n);
        ...
        (E.prototype.catch = function (n) {
          ...
          (E.resolve = function (n) {
            return n && "object" === f(n) && n.constructor === E
              ? n
              : new E(function (e) {
                  e(n);
                });
        ...
        function Y(n) {
          var e = this;
          (this.lang = n),
            (this.fallbackLang = this.lang.includes("-")
              ? this.lang.split("-")[0]
              : this.lang),
            (this.tran = function (n) {
              return (
                ...
                M[e.lang] && M[e.lang][n]
                  ? M[e.lang][n]
                  : M[e.fallbackLang] && M[e.fallbackLang][n]
                  ? M[e.fallbackLang][n]
                  : N[n]
                  ? N[n]
                  : n
        ...
        var N = {
          ...
          M = {
            ...
            de: {
              ...
              rolling: "Rollend",
              "input-danmaku-enter":
                "Drücke Enter nach dem Einfügen vom Danmaku",
            ...
            (a = [
              {
                ...
                value: function (n, e) {
                  var t = document.createElement("div");
                  return (
                    t.classList.add("dplayer-notice"),
                    (t.style.opacity = e),
                    (t.innerText = n),
                    t
                  );
                ...
                value: function () {
                  (this.container.innerHTML = Cn()({
                    ...
                    video: {
                      ...
                      airplay:
                        !(!z.isSafari || z.isChrome) && this.options.airplay,
                    ...
                    (this.ptime =
                      this.container.querySelector(".dplayer-ptime")),
                    ...
                    (this.dtime =
                      this.container.querySelector(".dplayer-dtime")),
                    ...
                    (this.chromecastButton = this.container.querySelector(
                      ".dplayer-chromecast-icon"
                    )),
                    ...
                    (this.subtitlesButton = this.container.querySelector(
                      ".dplayer-subtitles-icon"
                    )),
                    (this.subtitlesBox = this.container.querySelector(
                      ".dplayer-subtitles-box"
                    )),
                    (this.subtitlesItem = this.container.querySelectorAll(
                      ".dplayer-subtitles-item"
                    )),
                    (this.subtitle =
                      this.container.querySelector(".dplayer-subtitle")),
                    (this.subtrack =
                      this.container.querySelector(".dplayer-subtrack")),
                    ...
                    (this.barWrap =
                      this.container.querySelector(".dplayer-bar-wrap")),
                    (this.noticeList = this.container.querySelector(
                      ".dplayer-notice-list"
                    )),
                    ...
                    var t = this,
                      ...
                      r = function (r) {
                        t.options.apiBackend.read({
                          ...
                          error: function (i) {
                            t.options.error(
                              i || t.options.tran("danmaku-failed")
                            ),
                              (a[r] = []),
                              ++o === n.length && e(a);
                          },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this.dan.length && !this.paused && this.showing) {
                    for (
                      var e = this.dan[this.danIndex], t = [];
                      e && this.options.time() > parseFloat(e.time);

                    )
                      t.push(e), (e = this.dan[++this.danIndex]);
                    this.draw(t);
                  }
                  window.requestAnimationFrame(function () {
                    n.frame();
                  ...
                  if (this.showing) {
                      ...
                      i = function (n) {
                        var t = n.offsetWidth || parseInt(n.style.width),
                          a =
                            ...
                            e.container.getBoundingClientRect().right + t;
                          ...
                          var s = a / l(o),
                            p = function (o) {
                              ...
                              for (var d = 0; d < p.length; d++) {
                                var A = i(p[d]) - 10;
                                if (
                                  A <= a - s * l(parseInt(p[d].style.width)) ||
                                  A <= 0
                                )
                                  break;
                                if (d === p.length - 1)
                                  return (
                                    e.danTunnel[t][o + ""].push(n),
                                    n.addEventListener(
                                      "animationend",
                                      function () {
                                        e.danTunnel[t][o + ""].splice(0, 1);
                    ...
                    for (
                      var p = document.createDocumentFragment(),
                        d = function (o) {
                          (n[o].type = z.number2Type(n[o].type)),
                            n[o].color || (n[o].color = 16777215);
                          var r = document.createElement("div");
                          r.classList.add("dplayer-danmaku-item"),
                            r.classList.add(
                              "dplayer-danmaku-".concat(n[o].type)
                            ),
                            n[o].border
                              ? (r.innerHTML = '<span style="border:'
                                  .concat(n[o].border, '">')
                                  .concat(n[o].text, "</span>"))
                              : (r.innerHTML = n[o].text),
                            (r.style.opacity = e._opacity),
                            (r.style.color = z.number2Color(n[o].color)),
                          ...
                          switch (n[o].type) {
                            ...
                            case "bottom":
                              (l = s(r, n[o].type)) >= 0 &&
                                (r.style.bottom = t * l + "px");
                              break;
                            default:
                              console.error(
                                "Can't handled danmaku type: ".concat(n[o].type)
                              );
                          }
                          l >= 0 &&
                            (r.classList.add("dplayer-danmaku-move"),
                            (r.style.animationDuration = e._danAnimation(
                              n[o].type
                            )),
                            p.appendChild(r));
                        },
                ...
                value: function () {
                  for (
                    var n = this.container.offsetWidth,
                      e = this.container.getElementsByClassName(
                        "dplayer-danmaku-item"
                      ),
                      t = 0;
                    t < e.length;
          ...
          return (
            ...
            (t = [
              ...
              },
              {
                key: "type",
                value: function (n) {
                  return -1 !== this.playerEvents.indexOf(n)
                    ? "player"
                    : -1 !== this.videoEvents.indexOf(n)
                    ? "video"
                    : (console.error("Unknown event name: ".concat(n)), null);
                },
              },
            ]) && qn(e.prototype, t),
            Object.defineProperty(e, "prototype", { writable: !1 }),
              ...
              (this.fullscreenchange = function () {
                t.player.resize(),
                  t.isFullScreen("browser")
                    ? t.player.events.trigger("fullscreen")
                    : (z.setScrollPosition(t.lastScrollPosition),
            ...
            (t = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  switch (
                    (t || (this.lastScrollPosition = z.getScrollPosition()), n)
                  ) {
                    case "browser":
        ...
        var Mn = (function () {
          function n(e) {
            !(function (n, e) {
              ...
              (this.default = {
                opacity: 0.7,
                volume: e.options.hasOwnProperty("volume")
                  ? e.options.volume
                  : 0.7,
                unlimited:
                  (e.options.danmaku && e.options.danmaku.unlimited ? 1 : 0) ||
                  0,
                danmaku: 1,
                subtitle: 1,
              }),
            ...
            (t = [
              {
                ...
                value: function () {
                  for (var n in this.storageName) {
                    ...
                    this.data[n] = parseFloat(
                      z.storage.get(e) || this.default[n]
                    );
                  }
                },
              },
        ...
        var Pn = (function () {
          function n(e) {
            ...
            !(function (n, e) {
              ...
              this.player.template.subtitlesButton.addEventListener(
                "click",
                function () {
            ...
            for (
              var a = this.player.template.subtitlesItem.length - 1,
                o = function (n) {
                  t.player.template.subtitlesItem[n].addEventListener(
                    "click",
                    function () {
                      t.hide(),
                        t.player.options.subtitle.index !== n &&
                          ((t.player.template.subtitle.innerHTML = "<p></p>"),
                          (t.player.template.subtrack.src =
                            t.player.template.subtitlesItem[
                              n
                            ].dataset.subtitle),
                          (t.player.options.subtitle.index = n),
                          t.player.template.subtitle.classList.contains(
                            "dplayer-subtitle-hide"
                          ) && t.subContainerShow());
                    }
                  );
              ...
              o(r);
            this.player.template.subtitlesItem[a].addEventListener(
              "click",
              function () {
                t.hide(),
            ...
            (t = [
              {
                ...
                value: function () {
                  this.player.template.subtitle.classList.remove(
                    "dplayer-subtitle-hide"
                  ),
              ...
              },
              {
                ...
                value: function () {
                  this.player.template.subtitle.classList.add(
                    "dplayer-subtitle-hide"
                  ),
              ...
              },
              {
                key: "hide",
                value: function () {
                  this.player.template.subtitlesBox.classList.remove(
                    "dplayer-subtitles-box-open"
                  ),
              ...
              },
              {
                key: "show",
                value: function () {
                  this.player.template.subtitlesBox.classList.add(
                    "dplayer-subtitles-box-open"
                  ),
              ...
              },
              {
                ...
                value: function () {
                  var n = 30 * this.player.template.subtitlesItem.length + 14,
                    e = 0.8 * this.player.template.videoWrap.offsetHeight;
                  n >= e - 50
                    ? ((this.player.template.subtitlesBox.style.bottom = "8px"),
                      (this.player.template.subtitlesBox.style["max-height"] =
                        e - 8 + "px"))
                    : ((this.player.template.subtitlesBox.style.bottom =
                        "50px"),
                      (this.player.template.subtitlesBox.style["max-height"] =
                        e - 50 + "px"));
                },
            ...
            (t = [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.loadingChecker = setInterval(function () {
                    n.enableloadingChecker &&
                      ((t = n.player.video.currentTime),
                      a ||
                        t !== e ||
                        n.player.video.paused ||
                        (n.player.container.classList.add("dplayer-loading"),
                        (a = !0)),
                      a &&
                        t > e &&
                        !n.player.video.paused &&
                        (n.player.container.classList.remove("dplayer-loading"),
                        (a = !1)),
                      (e = t));
                  }, 100);
                },
                  ...
                  window.requestAnimationFrame(function () {
                    if (n.enablefpsChecker)
                      if ((n.initfpsChecker(), n.fpsStart)) {
                        ...
                        var e = new Date();
                        e - n.fpsStart > 1e3 &&
                          (n.player.infoPanel.fps(
                            (n.fpsIndex / (e - n.fpsStart)) * 1e3
                          ),
                          (n.fpsStart = new Date()),
                          (n.fpsIndex = 0));
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.types.map(function (e) {
                    return (
                      (n["enable".concat(e, "Checker")] = !1),
                      n["".concat(e, "Checker")] &&
                        clearInterval(n["".concat(e, "Checker")]),
                      e
                    );
                  });
                },
              ...
              },
              {
                ...
                value: function (n) {
                  (this.container.style.backgroundPosition = "-".concat(
                    160 * (Math.ceil((n / this.barWidth) * 100) - 1),
                    "px 0"
                  )),
                    (this.container.style.left = "".concat(
                      Math.min(
                        Math.max(n - this.container.offsetWidth / 2, -10),
                        this.barWidth - 150
                      ),
                      "px"
                    ));
        ...
        function re(n, e) {
          ...
          var a,
            ...
            i = [];
          try {
            for (; (void 0 === e || e-- > 0) && !(a = r.next()).done; )
              i.push(a.value);
          } catch (n) {
            o = { error: n };
          } finally {
                ...
                if (!this.closed) {
                  ...
                  if (r)
                    if (((this._parentage = null), Array.isArray(r)))
                      try {
                        for (var i = oe(r), l = i.next(); !l.done; l = i.next())
                          l.value.remove(this);
                      } catch (e) {
                        n = { error: e };
                      } finally {
          ...
          ve = {
            setTimeout: (function (n) {
              ...
              return (null == o ? void 0 : o.setTimeout)
                ? o.setTimeout.apply(o, ie([n, e], re(t)))
                : setTimeout.apply(void 0, ie([n, e], re(t)));
            }),
            ...
            function e(e, t, a) {
              ...
              return (
                le(e) || !e
                  ...
                  : i && ge
                  ? (((r = Object.create(e)).unsubscribe = function () {
        ...
        function qe(n) {
          var e;
          be
            ? ((e = n), be && ke && ((ke.errorThrown = !0), (ke.error = e)))
            : (function (n) {
              ...
              return (
                we(function () {
                  var n = o,
                    ...
                    t = n.source;
                  r.add(
                    e ? e.call(r, t) : t ? o._subscribe(r) : o._trySubscribe(r)
                  );
                }),
                r
              );
        ...
        function je(n) {
          var e;
          return null !== (e = null != n ? n : fe) && void 0 !== e
            ? e
            : Promise;
        }
        var Re,
          ...
          Ue = (function (n) {
            ...
            return (
              ...
              (e.prototype.next = function (n) {
                ...
                we(function () {
                  ...
                  if ((e._throwIfClosed(), !e.isStopped)) {
                    ...
                    try {
                      for (
                        var o = oe(e.currentObservers), r = o.next();
                        !r.done;
                        r = o.next()
                      )
                        r.value.next(n);
              ...
              (e.prototype._trySubscribe = function (e) {
                return (
                  this._throwIfClosed(), n.prototype._trySubscribe.call(this, e)
                );
              }),
            ...
            function n(e) {
              !(function (n, e) {
                ...
                this.player.options.subtitle &&
                  "string" == typeof this.player.options.subtitle.url &&
                  this.initSubtitleButton(),
                this.initHighlights(),
                this.initAirplayButton(),
                this.initChromecastButton(),
                z.isMobile || this.initVolumeButton();
            }
            var e, t;
            return (
              (e = n),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.player.on("durationchange", function () {
                      if (
                        1 !== n.player.video.duration &&
                        n.player.video.duration !== 1 / 0 &&
                        n.player.options.highlight
                      ) {
                        var e =
                          n.player.template.playedBarWrap.querySelectorAll(
                            ".dplayer-highlight"
                          );
                        ...
                        for (
                          var t = 0;
                          t < n.player.options.highlight.length;
                          t++
                        )
                          if (
                            n.player.options.highlight[t].text &&
                            n.player.options.highlight[t].time
                          ) {
                            var a = document.createElement("div");
                            a.classList.add("dplayer-highlight"),
                              (a.style.left =
                                (n.player.options.highlight[t].time /
                                  n.player.video.duration) *
                                  100 +
                                "%"),
                              (a.innerHTML =
                                ...
                                n.player.options.highlight[t].text +
                                "</span>"),
                              n.player.template.playedBarWrap.insertBefore(
                                a,
                                n.player.template.playedBarTime
                              );
                          }
                      }
                    });
                  ...
                  value: function () {
                    ...
                    this.player.options.video.thumbnails &&
                      ...
                      this.player.on("loadedmetadata", function () {
                        n.thumbnails.resize(
                          160,
                          (n.player.video.videoHeight /
                            n.player.video.videoWidth) *
                            160,
                          n.player.template.barWrap.offsetWidth
                        );
                      }));
                  },
                },
                      ...
                      e = function (e) {
                        var t =
                          ((e.clientX || e.changedTouches[0].clientX) -
                            z.getBoundingClientRectViewLeft(
                              n.player.template.playedBarWrap
                            )) /
                          n.player.template.playedBarWrap.clientWidth;
                        (t = Math.max(t, 0)),
                          (t = Math.min(t, 1)),
                          n.player.bar.set("played", t, "width"),
                          (n.player.template.ptime.innerHTML = z.secondToTime(
                            t * n.player.video.duration
                          ));
                      },
                      t = function t(a) {
                        document.removeEventListener(z.nameMap.dragEnd, t),
                          document.removeEventListener(z.nameMap.dragMove, e);
                        var o =
                        ...
                        (o = Math.max(o, 0)),
                          ...
                          n.player.seek(
                            n.player.bar.get("played") * n.player.video.duration
                          ),
                    ...
                    this.player.template.playedBarWrap.addEventListener(
                      ...
                      function () {
                        n.player.timer.disable("progress"),
                          document.addEventListener(z.nameMap.dragMove, e),
                          document.addEventListener(z.nameMap.dragEnd, t);
                      }
                    ),
                      this.player.template.playedBarWrap.addEventListener(
                        z.nameMap.dragMove,
                        function (e) {
                          if (n.player.video.duration) {
                            var t =
                                n.player.template.playedBarWrap.getBoundingClientRect()
                                  .left,
                              a =
                                (e.clientX || e.changedTouches[0].clientX) - t;
                            if (
                              a < 0 ||
                              a > n.player.template.playedBarWrap.offsetWidth
                            )
                              return;
                            var o =
                              n.player.video.duration *
                              (a / n.player.template.playedBarWrap.offsetWidth);
                            z.isMobile && n.thumbnails && n.thumbnails.show(),
                              n.thumbnails && n.thumbnails.move(a),
                              (n.player.template.playedBarTime.style.left =
                                "".concat(a - (o >= 3600 ? 25 : 20), "px")),
                              (n.player.template.playedBarTime.innerText =
                                z.secondToTime(o)),
                              n.player.template.playedBarTime.classList.remove(
                                "hidden"
                              );
                          }
                        }
                        ...
                        this.player.template.playedBarWrap.addEventListener(
                          ...
                          function () {
                            n.player.video.duration &&
                              ...
                              n.player.template.playedBarTime.classList.add(
                                "hidden"
                              ));
                          }
                        ));
                  ...
                  value: function () {
                    var n = this,
                        ...
                        var t = e || window.event,
                          a =
                            ((t.clientX || t.changedTouches[0].clientX) -
                              z.getBoundingClientRectViewLeft(
                                n.player.template.volumeBarWrap
                              ) -
                              5.5) /
                            35;
                        n.player.volume(a);
                      ...
                      t = function t() {
                        document.removeEventListener(z.nameMap.dragEnd, t),
                          document.removeEventListener(z.nameMap.dragMove, e),
                          n.player.template.volumeButton.classList.remove(
                            "dplayer-volume-active"
                          );
                      };
                    this.player.template.volumeBarWrapWrap.addEventListener(
                      ...
                      this.player.template.volumeBarWrapWrap.addEventListener(
                        ...
                        function () {
                          document.addEventListener(z.nameMap.dragMove, e),
                            document.addEventListener(z.nameMap.dragEnd, t),
                            n.player.template.volumeButton.classList.add(
                              "dplayer-volume-active"
                            );
                        }
                      ),
                      this.player.template.volumeButtonIcon.addEventListener(
                        "click",
                        function () {
                          n.player.video.muted
                            ? ((n.player.video.muted = !1),
                            ...
                            : ((n.player.video.muted = !0),
                              (n.player.template.volumeIcon.innerHTML =
                                En.volumeOff),
                      ...
                      this.player.template.qualityList.addEventListener(
                        ...
                        function (e) {
                          e.target.classList.contains("dplayer-quality-item") &&
                            n.player.switchQuality(e.target.dataset.index);
                        }
                      );
                  },
                },
                  ...
                  value: function () {
                    ...
                    n.setAttribute("type", "text/javascript"),
                      ...
                      (window.__onGCastApiAvailable = function (n) {
                        if (n) {
                          var e = new (Re = window.chrome.cast).SessionRequest(
                              Re.media.DEFAULT_MEDIA_RECEIVER_APP_ID
                            ),
                            t = new Re.ApiConfig(
                              e,
                              function () {},
                              function (n) {
                                n === Re.ReceiverAvailability.AVAILABLE &&
                                  console.log("chromecast: ", n);
                              }
                            );
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.player.options.chromecast) {
                      ...
                      this.player.template.chromecastButton.addEventListener(
                        "click",
                        function () {
                          var a;
                          Qe
                            ...
                            : ((Qe = !0),
                              ...
                              Re.requestSession(
                                function (o) {
                                  ...
                                  (n.session = o),
                                    a.next("CONNECTED"),
                                    (r = n.player.options.video.url),
                                    (i = new Re.media.MediaInfo(r)),
                                    (l = new Re.media.LoadRequest(i)),
                                    n.session
                                      ? n.session
                                          .loadMedia(
                                            l,
                                ...
                                function (e) {
                                  "cancel" === e.code
                                    ? ((n.session = void 0), a.next("CANCEL"))
                                    : console.error(
                                        "Error selecting a cast device",
                                        e
                                      );
                                }
                              ));
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.player.events.on("subtitle_show", function () {
                      (n.player.template.subtitleButton.dataset.balloon =
                        n.player.tran("hide-subs")),
          ...
          function n(e) {
            ...
            !(function (n, e) {
              ...
              this.player.template.loop.addEventListener("click", function () {
                (t.player.template.loopToggle.checked =
                  !t.player.template.loopToggle.checked),
                  t.player.template.loopToggle.checked
                    ? (t.loop = !0)
                    : (t.loop = !1),
              ...
              this.player.template.showDanmaku.addEventListener(
                "click",
                function () {
                  (t.player.template.showDanmakuToggle.checked =
                    !t.player.template.showDanmakuToggle.checked),
                    t.player.template.showDanmakuToggle.checked
                      ? ((t.showDanmaku = !0), t.player.danmaku.show())
                      : ((t.showDanmaku = !1), t.player.danmaku.hide()),
              ...
              this.player.template.unlimitDanmaku.addEventListener(
                "click",
                function () {
                  (t.player.template.unlimitDanmakuToggle.checked =
                    !t.player.template.unlimitDanmakuToggle.checked),
                    t.player.template.unlimitDanmakuToggle.checked
                      ? ((t.unlimitDanmaku = !0), t.player.danmaku.unlimit(!0))
                      : ((t.unlimitDanmaku = !1), t.player.danmaku.unlimit(!1)),
                    t.player.user.set("unlimited", t.unlimitDanmaku ? 1 : 0),
                    t.hide();
                }
              ),
              this.player.template.speed.addEventListener("click", function () {
                t.player.template.settingBox.classList.add(
                  "dplayer-setting-box-narrow"
                ),
                  t.player.template.settingBox.classList.add(
                    "dplayer-setting-box-speed"
            ...
            for (
              var a = function (n) {
                  t.player.template.speedItem[n].addEventListener(
                    "click",
                    function () {
                      t.player.speed(
                        t.player.template.speedItem[n].dataset.speed
                      ),
                        t.hide();
                    }
                  );
            ...
            if (this.player.danmaku) {
              ...
              var r = function (n) {
                  var e = n || window.event,
                    a =
                      ((e.clientX || e.changedTouches[0].clientX) -
                        z.getBoundingClientRectViewLeft(
                          t.player.template.danmakuOpacityBarWrap
                        )) /
                      130;
                  (a = Math.max(a, 0)),
                    (a = Math.min(a, 1)),
                ...
                i = function n() {
                  document.removeEventListener(z.nameMap.dragEnd, n),
                    document.removeEventListener(z.nameMap.dragMove, r),
                    t.player.template.danmakuOpacityBox.classList.remove(
                      "dplayer-setting-danmaku-active"
                    );
                };
              this.player.template.danmakuOpacityBarWrapWrap.addEventListener(
                ...
                this.player.template.danmakuOpacityBarWrapWrap.addEventListener(
                  z.nameMap.dragStart,
                  function () {
                    document.addEventListener(z.nameMap.dragMove, r),
                      document.addEventListener(z.nameMap.dragEnd, i),
                      t.player.template.danmakuOpacityBox.classList.add(
                        "dplayer-setting-danmaku-active"
                      );
                  }
                );
          ...
          function n(e) {
            ...
            !(function (n, e) {
              ...
              this.player.template.commentColorSettingBox.addEventListener(
                ...
                function () {
                  if (
                    t.player.template.commentColorSettingBox.querySelector(
                      "input:checked+span"
                    )
                  ) {
                    var n =
                ...
                value: function () {
                  ...
                  this.player.template.commentInput.blur(),
                    this.player.template.commentInput.value.replace(
                      ...
                      : this.player.notice(
                          this.player.tran("please-input-danmaku")
                        );
                },
              },
            ]) && Je(e.prototype, t),
                    ...
                    if (
                      ...
                      switch (o.keyCode) {
                        case 32:
                          ...
                          break;
                        case 37:
                          if ((o.preventDefault(), this.player.options.live))
                            break;
          ...
          function n(e) {
            ...
            !(function (n, e) {
              ...
              Array.prototype.slice
                ...
                .forEach(function (n, e) {
                  t.player.options.contextmenu[e].click &&
              ...
              (this.contextmenuHandler = function (n) {
                if (t.shown) t.hide();
                  ...
                  t.show(e.clientX - a.left, e.clientY - a.top),
                    t.player.template.mask.addEventListener(
                      "click",
                      function () {
                        t.hide();
                      }
              ...
              (function (n, e) {
                ...
                (this.options = (function (n) {
                  var e = {
                    container:
                      n.element ||
                      document.getElementsByClassName("dplayer")[0],
                    live: !1,
                    autoplay: !1,
                    theme: "#b7daff",
                    loop: !1,
                  ...
                  for (var t in e)
                    e.hasOwnProperty(t) &&
                      ...
                      (n[t] = e[t]);
                  return (
                    n.video && !n.video.type && (n.video.type = "auto"),
                    "object" === O(n.danmaku) &&
                      n.danmaku &&
                      !n.danmaku.user &&
                      (n.danmaku.user = "DIYgod"),
                    n.subtitle &&
                      (!n.subtitle.type && (n.subtitle.type = "webvtt"),
                    ...
                    n.video.quality &&
                      (n.video.url =
                        n.video.quality[n.video.defaultQuality].url),
                  ...
                  (function (n) {
                    for (var e = 1; e < arguments.length; e++) {
                      ...
                      e % 2
                        ? At(Object(t), !0).forEach(function (e) {
                            ct(n, e, t[e]);
                          })
                        ...
                        : At(Object(t)).forEach(function (e) {
                    ...
                    {
                      preload:
                        "webtorrent" === e.video.type ? "none" : "metadata",
                    },
                    e
                  )
                )),
                ...
                (this.tran = new Y(this.options.lang).tran),
                (this.events = new Dn()),
                (this.user = new jn(this)),
                (this.container = this.options.container),
                ...
                z.isMobile && this.container.classList.add("dplayer-mobile"),
                (this.arrow = this.container.offsetWidth <= 500),
                this.arrow && this.container.classList.add("dplayer-arrow"),
                this.options.subtitle &&
                  Array.isArray(this.options.subtitle.url) &&
                  (this.options.subtitle.url.push({
                    subtitle: "",
                    lang: "off",
                  }),
                  this.options.subtitle.defaultSubtitle &&
                    ("string" == typeof this.options.subtitle.defaultSubtitle
                      ? (this.options.subtitle.index =
                          this.options.subtitle.url.findIndex(function (n) {
                            return (
                              n.lang === t.options.subtitle.defaultSubtitle ||
                              n.name === t.options.subtitle.defaultSubtitle
                            );
                          }))
                      : "number" ==
                          typeof this.options.subtitle.defaultSubtitle &&
                        (this.options.subtitle.index =
                          this.options.subtitle.defaultSubtitle)),
                  (-1 === this.options.subtitle.index ||
                    !this.options.subtitle.index ||
                    this.options.subtitle.index >
                      this.options.subtitle.url.length - 1) &&
                    (this.options.subtitle.index =
                      this.options.subtitle.url.findIndex(function (n) {
                ...
                (this.bar = new Kn(this.template)),
                (this.bezel = new Gn(this.template.bezel)),
                (this.fullScreen = new Yn(this)),
                (this.controller = new Ke(this)),
                this.options.danmaku &&
                  ((this.danmaku = new zn({
                    player: this,
                ...
                (this.paused = !0),
                (this.timer = new Vn(this)),
                (this.hotkey = new tt(this)),
                (this.contextmenu = new rt(this)),
                this.initVideo(
                  this.video,
                  (this.quality && this.quality.type) || this.options.video.type
                ),
                (this.infoPanel = new st(this)),
              ...
              (t = [
                {
                  ...
                  value: function (n) {
                    (n = Math.max(n, 0)),
                      this.video.duration &&
                        (n = Math.min(n, this.video.duration)),
                      this.video.currentTime < n
                        ? this.notice(
                            "".concat(
                              this.tran("ff").replace(
                                "%s",
                                (n - this.video.currentTime).toFixed(0)
                              )
                            )
                          )
                        : this.video.currentTime > n &&
                          this.notice(
                            "".concat(
                              this.tran("rew").replace(
                                "%s",
                                (this.video.currentTime - n).toFixed(0)
                              )
                            )
                          ),
                      (this.video.currentTime = n),
                      ...
                      (this.template.ptime.innerHTML = z.secondToTime(n));
                  },
                },
                {
                  key: "play",
                  value: function (n) {
                    ...
                    if (
                      ...
                      this.video.paused &&
                        !z.isMobile &&
                        this.bezel.switch(En.play),
                      (this.template.playButton.innerHTML = En.pause),
                      (this.template.mobilePlayButton.innerHTML = En.pause),
                      n ||
                        S.resolve(this.video.play())
                          .catch(function () {
                            e.pause();
                          })
                          .then(function () {}),
                ...
                },
                {
                  ...
                  value: function (n) {
                    (this.paused = !0),
                      ...
                      this.video.paused ||
                        z.isMobile ||
                        this.bezel.switch(En.pause),
                      (this.template.playButton.innerHTML = En.play),
                      (this.template.mobilePlayButton.innerHTML = En.play),
                      n || this.video.pause(),
                ...
                },
                {
                  ...
                  value: function () {
                    this.volume() >= 0.95
                      ? (this.template.volumeIcon.innerHTML = En.volumeUp)
                      : this.volume() > 0
                      ? (this.template.volumeIcon.innerHTML = En.volumeDown)
                      : (this.template.volumeIcon.innerHTML = En.volumeOff);
                  },
                },
                {
                  key: "volume",
                  ...
                  value: function (n, e) {
                    ...
                    if (
                      ...
                      this.options.video.customType &&
                        this.options.video.customType[e])
                    )
                      "[object Function]" ===
                      Object.prototype.toString.call(
                        this.options.video.customType[e]
                      )
                        ? this.options.video.customType[e](this.video, this)
                        : console.error("Illegal customType: ".concat(e));
                    else
                      switch (
                        ("auto" === this.type &&
                          (/m3u8(#|\?|$)/i.exec(n.src)
                            ...
                            : (this.type = "normal")),
                        "hls" === this.type &&
                          (n.canPlayType("application/x-mpegURL") ||
                            ...
                            if (window.WebTorrent.WEBRTC_SUPPORT) {
                              ...
                              (n.src = ""),
                                ...
                                n.addEventListener(
                                  "durationchange",
                                  function () {
                                    return t.container.classList.remove(
                                      "dplayer-loading"
                                    );
                                  },
                                  { once: !0 }
                  ...
                  value: function (n, e) {
                    ...
                    this.initMSE(n, e),
                      this.on("durationchange", function () {
                        1 !== n.duration &&
                          n.duration !== 1 / 0 &&
                          (t.template.dtime.innerHTML = z.secondToTime(
                            n.duration
                          ));
                      }),
                      this.on("progress", function () {
                        var e = n.buffered.length
                          ? n.buffered.end(n.buffered.length - 1) / n.duration
                          : 0;
                      ...
                      this.on("error", function () {
                        t.video.error &&
                          ...
                          t.notice &&
                          "webtorrent" !== t.type &&
                          t.notice(t.tran("video-failed"), -1);
                      }),
                      this.on("ended", function () {
                        t.bar.set("played", 1, "width"),
                          t.setting.loop ? (t.seek(0), t.play()) : t.pause(),
                      ...
                      this.on("timeupdate", function () {
                        t.bar.set(
                          "played",
                          t.video.currentTime / t.video.duration,
                          "width"
                        );
                        var n = z.secondToTime(t.video.currentTime);
                        t.template.ptime.innerHTML !== n &&
                          (t.template.ptime.innerHTML = n);
                      });
                    for (
                      var a = function (e) {
                          n.addEventListener(
                            t.events.videoEvents[e],
                            function () {
                ...
                },
                {
                  ...
                  value: function (n) {
                    var e = this;
                    if (
                      ((n = "string" == typeof n ? parseInt(n) : n),
                      ...
                      var a = dt()({
                        ...
                        o = new DOMParser().parseFromString(a, "text/html").body
                          .firstChild;
                      this.template.videoWrap.insertBefore(
                        ...
                        this.notice(
                          "".concat(
                            this.tran("switching-quality").replace(
                              "%q",
                              this.quality.name
                            )
                          ),
                          ...
                          if (e.prevVideo) {
                            ...
                            e.template.videoWrap.removeChild(e.prevVideo),
                              ...
                              e.notice(
                                "".concat(
                                  e
                                    .tran("switched-quality")
                                    .replace("%q", e.quality.name)
                                )
                              ),
                        ...
                        this.on("error", function () {
                          e.video.error &&
                            e.prevVideo &&
                            (e.template.videoWrap.removeChild(e.video),
                            (e.video = e.prevVideo),
                            t || e.video.play(),
                            (e.qualityIndex = e.prevIndex),
                            (e.quality =
                              e.options.video.quality[e.qualityIndex]),
                    ...
                    var e,
                      ...
                      o =
                        arguments.length > 2 && void 0 !== arguments[2]
                          ...
                          : 0.8,
                      r = Bn.NewNotice(n, o);
                    this.template.noticeList.appendChild(r),
                      this.events.trigger("notice_show", r),
                      a > 0 &&
                        setTimeout(
                          ((e = r),
                          (t = this),
        ...
        console.log(
          "\n"
            .concat(" %c DPlayer v", "1.27.0", " ")
            .concat("a0424ca", " %c https://dplayer.diygod.dev ", "\n", "\n"),
